...
Put the reference images you sent into `frontend/assets/images/` with these filenames:
...
- `campus-4.png` (campus view #4)
- `president.png` (president photo)
- `kdu-logo.png` (KDU logo)
- `news-1.png` (news image #1)
- `news-2.png` (news image #2)
- `news-3.png` (news image #3)
- `student-1.png` (student testimonial #1)
- `student-2.png` (student testimonial #2)
- `student-3.png` (student testimonial #3)
- `program-smart-computing.png` (program card image)
- `program-artificial-intelligence.png` (program card image)
- `program-international-hotel-management.png` (program card image)
- `program-international-business-management.png` (program card image)
- `event-1.png` (event card image)
- `event-2.png` (event card image)
